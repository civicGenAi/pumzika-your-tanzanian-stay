...
const Login = () => {
    ...
    return (
        <div className="flex min-h-screen flex-col bg-background md:flex-row">
            {/* Left side - Visual background (stunning) */}
            <div className="relative hidden w-1/2 overflow-hidden bg-primary md:block">
                <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1544620347-c4fd4a3d5957?w=1200&fit=crop')] bg-cover bg-center mix-blend-overlay opacity-40" />
                <div className="absolute inset-0 bg-gradient-to-br from-primary via-primary/80 to-transparent" />

                <div className="relative z-10 flex h-full flex-col justify-between p-12 text-primary-foreground">
                    <Link to="/" className="flex items-center gap-2">
                        <BaobabLogo className="h-10 w-10 fill-primary-foreground" />
                    ...
                    <div className="max-w-md space-y-6">
                        ...
                        <p className="text-lg text-primary-foreground/80">
                            Pick up where you left off. Your saved stays and upcoming trips are waiting for you.
                        </p>
                    </div>
